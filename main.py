...
def draw_box(x, y):
    if x == None and y == None:
        return
    for i in range(2):
        pygame.draw.line(screen, (223, 0, 0), (x * box * 3, (y + i)
                                               * box * 3), (x * box * 3 + box * 3, (y + i) * box * 3), 4)
        pygame.draw.line(screen, (223, 0, 0), ((
            x + i) * box * 3, y * box * 3), ((x + i) * box * 3, y * box * 3 + box * 3), 4)
        ...
        for j in range(3):
            ...
            for p in range(3):
                for q in range(3):
                    ...
                    if grid[i][j][p][q] == 2:
                        screen.blit(x_img, ((3 * i + p) * box +
                                            box/15, (3 * j + q) * box + box/15))
                    if grid[i][j][p][q] == 1:
                        screen.blit(o_img, ((3 * i + p) * box +
                                            box/15, (3 * j + q) * box + box/15))
    for i in range(10):
        if i % 3 == 0:
            pygame.draw.line(screen, (223, 223, 0),
                             (box * i, 0), (box * i, 9 * box), 5)
            pygame.draw.line(screen, (223, 223, 0),
                             (0, box * i), (9 * box, box * i), 5)
        else:
            pygame.draw.line(screen, (223, 223, 0),
                             (0, box * i), (9 * box, box * i), 3)
            pygame.draw.line(screen, (223, 223, 0),
                             (box * i, 0), (box * i, 9 * box), 3)
